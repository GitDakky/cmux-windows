...
public static class TerminalThemes
{
    ...
    public static Dictionary<string, TerminalTheme> BuiltIn { get; } = new()
    {
        ...
        ["Light"] = new TerminalTheme
        {
            Name = "Light",
            Author = "cmux",
            Background = new TerminalColor(0xF5, 0xF5, 0xF7),
            Foreground = new TerminalColor(0x1A, 0x1A, 0x2E),
            CursorColor = new TerminalColor(0x4F, 0x46, 0xE5),
            SelectionBg = new TerminalColor(0xD4, 0xD4, 0xDC),
            Palette =
            [
                new(0xE5, 0xE7, 0xEB), new(0xDC, 0x26, 0x26), new(0x05, 0x96, 0x69), new(0xD9, 0x77, 0x06),
                new(0x43, 0x38, 0xCA), new(0x7C, 0x3A, 0xED), new(0x0D, 0x94, 0x88), new(0x1F, 0x29, 0x37),
                new(0x6B, 0x72, 0x80), new(0xEA, 0x58, 0x0C), new(0x10, 0xB9, 0x81), new(0xCA, 0x8A, 0x04),
                new(0x4F, 0x46, 0xE5), new(0x8B, 0x5C, 0xF6), new(0x14, 0xB8, 0xA6), new(0x11, 0x18, 0x27),
            ],
        },
        ["High Contrast"] = new TerminalTheme
        {
            Name = "High Contrast",
            Author = "cmux",
            Background = new TerminalColor(0x00, 0x00, 0x00),
            Foreground = new TerminalColor(0xFF, 0xFF, 0xFF),
            CursorColor = new TerminalColor(0xFF, 0xFF, 0x00),
            SelectionBg = new TerminalColor(0x33, 0x33, 0x33),
            Palette =
            [
                new(0x00, 0x00, 0x00), new(0xFF, 0x00, 0x00), new(0x00, 0xFF, 0x00), new(0xFF, 0xFF, 0x00),
                new(0x00, 0xFF, 0xFF), new(0xFF, 0x00, 0xFF), new(0xFF, 0xFF, 0xFF), new(0xFF, 0xFF, 0xFF),
                new(0x80, 0x80, 0x80), new(0xFF, 0x80, 0x80), new(0x80, 0xFF, 0x80), new(0xFF, 0xFF, 0x80),
                new(0x80, 0xFF, 0xFF), new(0xFF, 0x80, 0xFF), new(0xFF, 0xFF, 0xFF), new(0xFF, 0xFF, 0xFF),
            ],
        },
        ["Cyberpunk"] = new TerminalTheme
        {
            Name = "Cyberpunk",
            Author = "cmux",
            Background = new TerminalColor(0x0A, 0x0E, 0x17),
            Foreground = new TerminalColor(0xE0, 0xE7, 0xFF),
            CursorColor = new TerminalColor(0x00, 0xF0, 0xFF),
            SelectionBg = new TerminalColor(0x1F, 0x29, 0x37),
            Palette =
            [
                new(0x0D, 0x11, 0x1C), new(0xFF, 0x00, 0x80), new(0x39, 0xFF, 0x14), new(0xFF, 0xFF, 0x00),
                new(0x00, 0xF0, 0xFF), new(0xFF, 0x00, 0xFF), new(0x00, 0xB8, 0xD4), new(0xE0, 0xE7, 0xFF),
                new(0x8B, 0x9C, 0xB3), new(0xFF, 0x4D, 0x94), new(0x7C, 0xFF, 0x4D), new(0xFF, 0xD6, 0x00),
                new(0x00, 0xE5, 0xFF), new(0xFF, 0x66, 0xFF), new(0x00, 0xFF, 0xCC), new(0xFF, 0xFF, 0xFF),
            ],
        },
    };
